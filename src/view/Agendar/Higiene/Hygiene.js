...
import { HYGIENE_LIST, RADIO_PROPS } from '../../../variables/general'
...
class Hygiene extends Component {
  ...
  async save() {
    let selecteds = {
      banho: this.state.selectedItems.includes("Banho") ? "yes" : "no",
      tosa: this.state.selectedItems.includes("Tosa") ? "yes" : "no"
    }
    ...
    return (
      ...
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={styles.secondContainer}>
          {/* Área da entrada da data e hora */}
